            ...
            <el-aside width="230px">
                ...
                <el-menu
                    ...
                    active-text-color="#ffd04b">
                     <el-menu-item index="0" :route="{name: 'listProduct'}">
                        <i class="el-icon-menu"></i>
                        <span>Banner</span>
                    </el-menu-item>
                    <el-menu-item index="0" :route="{name: ''}">
                        <i class="el-icon-menu"></i>
                        <span>Product</span>
                    </el-menu-item>
            ...
            <el-container>
                <el-header>
                    <div class="menu-header">
                      ...
                      <span class="el-dropdown-link acount-name">
                        Administrator
                        <i class="el-icon-arrow-down el-icon--right"></i>
                      </span>
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item>Change profile</el-dropdown-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            logout() {
                this.$axios.post('http://127.0.0.1:8000/api/v1/logout')
                    .then((res) => {
                        if (res.status === 200) {
