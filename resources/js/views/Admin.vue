            ...
            <nav class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="#" @click="setComponent('products')"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Products</span></a>
                        </li>
                        <li>
                            <a href="#"  @click="setComponent('orders')"><i class="fa fa-pie-chart"></i> <span class="nav-label">Order</span>  </a>
                        </li>
                        <li>
                            <a href="#" @click="setComponent('users')"><i class="fa fa-edit"></i> <span class="nav-label">Users</span></a>

                        </li>
                        <li>
                            <a href="#" @click="setComponent('#')"><i class="fa fa-edit"></i> <span class="nav-label">Suppliers</span></a>
                        </li>
                        <li>
                            <a href="#" @click="setComponent('#')"><i class="fa fa-edit"></i> <span class="nav-label">Revenue statistics</span></a>
                        </li>
                    </ul>
                </div>
            </nav>
